...
class CocktailsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cocktail" do
    assert_difference('Cocktail.count') do
      post cocktails_url, params: { cocktail: { content: @cocktail.content, name: @cocktail.name, rating: @cocktail.rating } }
    end
  ...
  test "should update cocktail" do
    patch cocktail_url(@cocktail), params: { cocktail: { content: @cocktail.content, name: @cocktail.name, rating: @cocktail.rating } }
